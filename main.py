...
class VaultApp(App):
    ...
    def launch_retroarch_game(self, game: GameInfo):
        ...
        try:
            ...
            # Use only the three confirmed RetroArch launch values.
            intent.putExtra("CONFIGFILE", RETROARCH_CONFIG_PATH)
