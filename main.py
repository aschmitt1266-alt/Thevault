...
NES_CORE_PATH = (
    "/data/user/0/com.retroarch.aarch64/"
    "cores/nestopia_libretro_android.so"
)
...
class VaultApp(App):
    ...
    def launch_retroarch_game(self, game: GameInfo):
        ...
        try:
            ...
            # The universal website APK commonly uses com.retroarch,
            # while the dedicated 64-bit APK uses com.retroarch.aarch64.
            candidates = (
            ...
            for package_name in candidates:
                try:
                    core_path = (
                        f"/data/data/{package_name}/cores/"
                        "nestopia_libretro_android.so"
                    )
                    config_path = (
                        "/storage/emulated/0/Android/data/"
                        f"{package_name}/files/retroarch.cfg"
                    )
                    ...
                    print(
                        "RetroArch launched with package: "
                        f"{package_name}"
                    )
                    break
                    ...
                    error_text = (
                        f"{package_name}: {candidate_error}"
                    )
